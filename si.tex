...
%% Supplementary References continue the numbering of the main-text reference list (Nature/NCS SI rule).
%% build.sh writes si_refoffset.tex from the number of \bibitem entries in main.bbl; if the file is
%% missing, the offset is 0 and the SI list restarts at 1.
\usepackage{etoolbox}%
\InputIfFileExists{si_refoffset.tex}{}{\def\SIrefoffset{0}}%
\makeatletter
\apptocmd{\thebibliography}{\global\c@NAT@ctr\SIrefoffset\relax}{}{\ClassWarning{si}{reference offset not applied}}%
\makeatother
...
\hypersetup{pdftitle={Supplementary Information: Transfer-Learning Surrogates for Scalable Multi-Fidelity Bayesian Optimization in Molecular and Materials Discovery},
...
\abstract{This file contains Supplementary Notes 1--7, Supplementary Figures 1--4 and Supplementary Tables 1--9, which are referred to from the main text. Figure and table
...
\clearpage % flush the Supplementary Figures and Tables before the reference list
