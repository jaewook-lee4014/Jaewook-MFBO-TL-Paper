...
%% (MMD)) and to the Fig. 1b-p attainment result (TL-base at or above the baseline MFGP on all 9 chemistry & materials pools).
...
\end{scope}
\node[text=sub, font=\footnotesize, anchor=north] at (\Cc,2.62) {TL-base $\geq$ MFGP on all 9 chemistry \& materials pools};
