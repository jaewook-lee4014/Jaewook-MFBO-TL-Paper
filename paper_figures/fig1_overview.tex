...
%% (MMD)) and to the Fig. 1b-p attainment result (TL-base at or above GP-base on all 9 chemistry & materials pools).
...
\end{scope}
\node[text=sub, font=\footnotesize, anchor=north] at (\Cc,2.62) {TL-base $\geq$ GP-base on all 9 chemistry \& materials pools};
