...
%% regret and compute scaling (a-c); Table 1 benchmark suite. SI: Supplementary Notes 1-7, Figs 1-3, Tables 1-9.
...
discovery: within our protocol the choice of surrogate, more than the acquisition policy, governs MFBO performance on descriptor-based molecular and materials pools.
...
direct: on descriptor-based molecular and materials pools, a transfer-learning surrogate is a more reliable default than the baseline MFGP and, in the separate nine-task compute profiles, every transfer-learning surrogate cost fewer FLOPs than the two GP variants, by up to roughly $22\times$.
